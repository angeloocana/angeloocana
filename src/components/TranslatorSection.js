...
const OtherLanguages = () => (
  <div style={{ textAlign: 'center' }}>
    <p>
      This article is also available in <a href="/ja/">Japanese</a> and in <a href="/zh/">Chinese (simplified)</a>.
    </p>
    <p>
  ...
  return (
    <div>
      {language === 'ja' && <div style={{ textAlign: 'center', paddingBottom: '2rem' }}>
        <img src={`/img/${language}/rising-stars.png`} className="img-responsive" alt="Rising Stars 2016" />
      </div>}
